...
import facebookIcon from "/src/assets/icons/socialmedia/facebook-icon.svg";
import instagramIcon from "/src/assets/icons/socialmedia/instagram-icon.svg";
import twitterIcon from "/src/assets/icons/socialmedia/twitter-icon.svg";
import youtubeIcon from "/src/assets/icons/socialmedia/youtube-icon.svg";
      ...
      <footer className="p-5 lg:p-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          <div className="flex flex-col gap-5">
            <img src={logoBlue} alt="Tickitz Logo" className="w-50" />
          ...
          <div className="flex flex-col gap-5">
            ...
            <ul className="flex flex-wrap items-end justify-between gap-10 md:justify-normal lg:flex-col lg:flex-nowrap lg:items-start">
              <li>
                <img src={ebvLogo} alt="EBV Sponsor Logo" />
              </li>
              <li>
                <img src={cineOneLogo} alt="CineOne Sponsor Logo" />
              </li>
              <li>
                <img src={hiflixLogo} alt="hiflix Sponsor Logo" />
              </li>
            </ul>
          </div>
